package com.alpha1zln.SpringSecProj.config;

import com.alpha1zln.SpringSecProj.service.CustomUserDetailsService;
...
//                 .anyRequest().authenticated() // Req authentication to all other endpoints
//             )
//             .formLogin(form -> form
//                 .loginPage("/login") // Custom login page
